...
try {
    ...
    echo "<br><strong>Please update your database credentials in config/database.php:</strong><br>";
    ...
    echo "4. Update the credentials in config/database.php<br>";
...
echo "<h2>Step 4: Server Environment Check</h2>";
